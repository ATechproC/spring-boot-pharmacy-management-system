...
import com.atechproc.service.image.IImageService;
import com.atechproc.service.image.ImageService;
...
public class ImageController {
    ...
    public ResponseEntity<ApiResponse> saveImages(
        ...
        try {
            List<ImageDto> imagesDto = imageService.saveImages(files, medicineId);
            return ResponseEntity.ok(new ApiResponse("Uploaded Successfully", imagesDto));
        }catch(Exception e) {
